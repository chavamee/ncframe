...
public:
    ...
    virtual void onItemAction(Menu::Item* item)
    {
        NCF_UNUSED(item);
    }

    bool _invokeAction(Menu::Item& item);
        ...
        virtual void onItemDeselected(Item* item)
        {
            NCF_UNUSED(item);
        }
        ...
        inline void setCurrentItem(Item& item);
    ...
    private:
        ...
        ITEM** _unpackItems(std::vector<Item*>& items);
};
